...
Currently available applets include:
	...
	date, dc, dd, deallocvt, delgroup, deluser, depmod, devmem,
	...
	fbset, fbsplash, fdflush, fdformat, fdisk, fgconsole, fgrep, findfs,
	flock, fold, free, freeramdisk, fstrim, fsync, ftpd, ftpget, ftpput,
	fuser, getopt, getty, grep, groups, gunzip, gzip, halt, hdparm,
	head, hostid, hostname, httpd, hush, i2cdetect, i2cdump, i2cget,
	i2cset, id, ifconfig, ifdown, ifenslave, ifplugd, ifup, inetd, init,
	insmod, install, ionice, iostat, ip, ipaddr, ipcalc, iplink,
	iproute, iprule, iptunnel, kbd_mode, kill, killall, killall5, klogd,
	last, less, linux32, linux64, linuxrc, ln, loadfont, loadkmap,
	logger, login, logname, logread, lpd, lpq, lpr, ls, lsattr, lsmod,
	lsof, lzcat, lzma, lzop, lzopcat, makedevs, makemime, man, md5sum,
	mdev, mesg, microcom, mkdir, mkfifo, mknod, mkpasswd, modinfo,
	modprobe, mount, mountpoint, mpstat, mt, mv, nameif, nanddump,
	nandwrite, nbd-client, nc, netstat, nice, nmeter, nohup, nslookup,
	ntpd, od, openvt, passwd, patch, pgrep, pidof, ping, ping6,
	pipe_progress, pkill, pmap, popmaildir, poweroff, powertop,
	...
	strings, stty, su, sulogin, sum, sv, svlogd, sync, sysctl, syslogd,
